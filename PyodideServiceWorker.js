...
const appCacheName = 'Panel Material UI-0.2.0';

const preCacheFiles = [];

const cachePatterns = ['https://cdn.holoviz.org/panel/1.7.2-a.0/dist/', 'https://cdn.bokeh.org/bokeh/', 'https://cdn.jsdelivr.net/pyodide/', 'https://files.pythonhosted.org/packages/', 'https://pypi.org/pypi/'];
