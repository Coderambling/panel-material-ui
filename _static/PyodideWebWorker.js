...
const REQUIRES = ["panel-material-ui"]
...
async function loadApplication(cell_id, path) {
  ...
  const packages = ['https://cdn.holoviz.org/panel/wheels/bokeh-3.7.3-py3-none-any.whl', 'https://cdn.holoviz.org/panel/wheels/panel-1.7.2a0-py3-none-any.whl', 'pyodide-http'];
  if (path != null) {
